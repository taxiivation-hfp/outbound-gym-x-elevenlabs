...
export default function WithdrawnNumber() {
  return (
    <Section title="We deleted our best number" lead>
      ...
      <p className="m-0 max-w-[80ch] text-[13.5px] leading-[1.6] text-ink-2 text-pretty">
        We removed our 90.4% accuracy claim. The answer key was generated by the same rules we were testing, so it only proved two copies of one
        ruleset agreed.
      </p>
    </Section>
  );
